...
export const sanfordPage = {
  ...
  faqs: [
    ...
    {
      question: 'What should the wide property photo show?',
      answer:
        'Show the full driveway or entry approach, nearby curb or sidewalk, parked vehicles, gates, drains, and adjoining materials.',
    },
    {
      question: 'Can several connected Sanford concrete areas be combined?',
      answer:
        'Yes. Put the driveway, front walk, entry pad, apron, or patio in one request and identify each area in the photos.',
    },
  ],
